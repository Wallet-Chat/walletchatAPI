...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/is_moderator/{company}/{address}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Address to check if is moderator",
                        "name": "address",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "domain/company to check",
                        "name": "company",
                        "in": "path",
                        "required": true
                    }
